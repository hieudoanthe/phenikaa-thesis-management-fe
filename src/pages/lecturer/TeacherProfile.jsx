...
const TeacherProfile = () => {
  ...
  const specializationOptions = [
    ...
    {
      value: "Mạng máy tính và truyền thông dữ liệu",
      label: "Mạng máy tính và truyền thông dữ liệu",
    },
    { value: "An toàn thông tin", label: "An toàn thông tin" },
    {
      value: "Hệ thống thông tin quản lý",
      label: "Hệ thống thông tin quản lý",
    },
    {
      value: "Trí tuệ nhân tạo (AI) và Robotics",
      label: "Trí tuệ nhân tạo (AI) và Robotics",
    },
    {
      value: "Khoa học dữ liệu (Data Science)",
      label: "Khoa học dữ liệu (Data Science)",
    },
